"""
Django settings for ryan_bandwidth_test_40176 project.
...
ROOT_URLCONF = 'ryan_bandwidth_test_40176.urls'
...
WSGI_APPLICATION = 'ryan_bandwidth_test_40176.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ryan_bandwidth_test_40176 API",
    "DESCRIPTION": "API documentation for ryan_bandwidth_test_40176 App",
    "VERSION": "v1",
}
